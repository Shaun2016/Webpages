$(document).ready(function(){
	...
	function enableMobileNav(){
		...
		$('#menu-button').click(function(){
			...
			if(!$('.wp_nav').hasClass('navigation-opened')){
				
				$('.wp_nav').slideDown(500).addClass('navigation-opened');
				
			}else{
				
				$('.wp_nav').slideUp(500).removeClass('navigation-opened');
		...
		$(window).resize(function(){
			...
			if(window_w > 991){
				...
				$('.wp_nav').show().attr('style','').removeClass('navigation-opened');
